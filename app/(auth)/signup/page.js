...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F3] text-[#111111] pb-12">
      ...
      <main className="max-w-lg mx-auto px-4 sm:px-8 pt-2 sm:pt-4 pb-12 w-full">
        <div className="bg-white rounded-3xl sm:rounded-4xl px-5 sm:px-10 py-6 sm:py-8 shadow-xl border border-black/5 flex flex-col gap-5 sm:gap-6">
          ...
          <button
            ...
            className="w-full py-3.5 px-4 bg-[#24292F] hover:bg-[#1B1F23] text-white rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2.5 shadow-sm cursor-pointer"
          >
