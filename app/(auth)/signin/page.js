    ...
    <div className="min-h-screen bg-[#F5F5F3] text-[#111111] pb-12">
      ...
      <main className="max-w-md mx-auto px-4 pt-28 sm:pt-32">
        <div className="bg-white rounded-[32px] p-8 shadow-xl border border-black/5 flex flex-col gap-6">
          ...
          {/* Quick One-Click Demo Buttons (Direct Links) */}
          <div className="bg-[#F8F9FA] rounded-2xl p-4 border border-black/5 flex flex-col gap-2.5">
            <div className="text-[11px] font-bold uppercase tracking-wider text-[#494D4D]">
              ⚡ QUICK DEMO ONE-CLICK SIGN IN
            </div>
            <div className="grid grid-cols-2 gap-2">
              <Link
                href="/dashboard"
                className="flex items-center justify-center gap-1.5 py-3 px-3 bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer text-center"
              >
                <UserCheck className="w-4 h-4" />
                <span>Demo Student</span>
              </Link>
              <Link
                href="/admin/fairness"
                className="flex items-center justify-center gap-1.5 py-3 px-3 bg-[#0F172A] hover:bg-slate-800 active:scale-95 text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer text-center"
              >
                <ShieldCheck className="w-4 h-4 text-emerald-400" />
                <span>Demo Admin</span>
              </Link>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="mt-1 w-full py-3.5 px-4 bg-neutral-900 text-white rounded-2xl font-bold text-xs hover:bg-neutral-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-md cursor-pointer"
            >
              <span>Sign In to Dashboard</span>
              <ArrowRight className="w-4 h-4 text-emerald-400" />
            </button>
