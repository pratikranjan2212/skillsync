...
import { BookOpen, ShieldCheck, Scale, QrCode, FileText, CheckCircle2, ArrowRight } from "lucide-react";
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-32 pb-20 w-full">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-neutral-900 tracking-tight">
            SkillSync Developer & Architecture Docs
          </h1>
          <p className="text-neutral-600 text-sm sm:text-base mt-4">
            Technical overview of the automated skill verification pipeline, explainable matching engine, and fairness audit protocol.
          </p>
        </div>
        ...
        <div className="mt-12 p-8 rounded-3xl bg-neutral-900 text-white flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-neutral-400 mt-1">Check verified skill evidence and view explainable job matching scores.</p>
          </div>
          <Link
            href="/passport"
