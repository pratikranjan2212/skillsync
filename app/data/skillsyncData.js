...
export const SMART_ASSIST_CARDS = [
  {
    ...
    icon: "CheckCircle2",
    iconBg: "bg-[#10b981]",
    iconShadow: "shadow-[0_10px_24px_rgba(16,185,129,0.55)]",
    cardGlow: "shadow-[0_28px_56px_-10px_rgba(16,185,129,0.42),0_12px_24px_-8px_rgba(0,0,0,0.08)] border border-emerald-500/20 hover:border-emerald-500/60 hover:shadow-[0_36px_72px_-10px_rgba(16,185,129,0.58),0_16px_32px_-6px_rgba(0,0,0,0.14)]",
  ...
  },
  {
    ...
    icon: "Award",
    iconBg: "bg-[#f59e0b]",
    iconShadow: "shadow-[0_10px_24px_rgba(245,158,11,0.55)]",
    cardGlow: "shadow-[0_28px_56px_-10px_rgba(245,158,11,0.42),0_12px_24px_-8px_rgba(0,0,0,0.08)] border border-amber-500/20 hover:border-amber-500/60 hover:shadow-[0_36px_72px_-10px_rgba(245,158,11,0.58),0_16px_32px_-6px_rgba(0,0,0,0.14)]",
  ...
  },
  {
    ...
    icon: "Briefcase",
    iconBg: "bg-[#3b82f6]",
    iconShadow: "shadow-[0_10px_24px_rgba(59,130,246,0.55)]",
    cardGlow: "shadow-[0_28px_56px_-10px_rgba(59,130,246,0.42),0_12px_24px_-8px_rgba(0,0,0,0.08)] border border-blue-500/20 hover:border-blue-500/60 hover:shadow-[0_36px_72px_-10px_rgba(59,130,246,0.58),0_16px_32px_-6px_rgba(0,0,0,0.14)]",
  ...
  },
  {
    ...
    icon: "Scale",
    iconBg: "bg-[#262626]",
    iconShadow: "shadow-[0_10px_24px_rgba(0,0,0,0.55)]",
    cardGlow: "shadow-[0_28px_56px_-10px_rgba(0,0,0,0.48),0_12px_24px_-8px_rgba(0,0,0,0.12)] border border-black/10 hover:border-neutral-900/60 hover:shadow-[0_36px_72px_-10px_rgba(0,0,0,0.65),0_16px_32px_-6px_rgba(0,0,0,0.18)]",
