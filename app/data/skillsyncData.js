...
export const SMART_ASSIST_CARDS = [
  {
    ...
    title: "Multi-Source Evidence Extractor",
    description: "Extracts verified coursework, grade transcripts, and GitHub repositories via automated OCR and digital signatures.",
  },
  {
    id: "c2",
    icon: "Award",
    ...
    title: "Explainable Skill Graph",
    description: "Converts academic transcripts into standardized, portable skill badges with transparent evidence citations.",
  },
  {
    id: "c3",
    icon: "Briefcase",
    ...
    description: "Continuously ingests public internship and job listings from Adzuna, Jooble, and Remotive APIs.",
  },
  {
    id: "c4",
    icon: "Scale",
