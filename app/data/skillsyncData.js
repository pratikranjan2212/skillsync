...
export const SMART_ASSIST_CARDS = [
  {
    ...
    iconShadow: "shadow-[0_10px_24px_2px_rgba(16,185,129,0.6)]",
    cardGlow: "shadow-[0_18px_40px_-8px_rgba(16,185,129,0.25)] border border-emerald-500/20 hover:border-emerald-500/50",
  ...
  },
  {
    ...
    icon: "Award",
    iconBg: "bg-amber-500",
    iconShadow: "shadow-[0_10px_24px_2px_rgba(245,158,11,0.6)]",
    cardGlow: "shadow-[0_18px_40px_-8px_rgba(245,158,11,0.25)] border border-amber-500/20 hover:border-amber-500/50",
  ...
  },
  {
    ...
    icon: "Briefcase",
    iconBg: "bg-blue-500",
    iconShadow: "shadow-[0_10px_24px_2px_rgba(59,130,246,0.6)]",
    cardGlow: "shadow-[0_18px_40px_-8px_rgba(59,130,246,0.25)] border border-blue-500/20 hover:border-blue-500/50",
  ...
  },
  {
    ...
    icon: "Scale",
    iconBg: "bg-[#111111]",
    iconShadow: "shadow-[0_10px_24px_2px_rgba(17,17,17,0.6)]",
    cardGlow: "shadow-[0_18px_40px_-8px_rgba(0,0,0,0.25)] border border-black/10 hover:border-neutral-900/50",
