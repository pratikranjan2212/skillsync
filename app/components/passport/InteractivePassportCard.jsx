...
function GenderIcon() {
  return (
    <svg className="w-3 h-3 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
  ...
  const renderPassportFront = (isEnlarged = false) => (
    <div className={`w-full bg-linear-to-br from-[#0c382b] via-[#09291f] to-[#041711] text-white rounded-3xl ${isEnlarged ? "p-6 sm:p-9" : "p-5 sm:p-6"} border border-emerald-400/30 shadow-[0_24px_60px_-12px_rgba(4,38,28,0.7),_0_0_0_1px_rgba(52,211,153,0.25)] overflow-hidden relative flex flex-col justify-between`}>
      ...
      <svg 
        ...
        fill="none"
      >
        <path d="M0,180 C150,120 280,200 450,130 C490,110 520,70 600,60" stroke="#34D399" strokeWidth="1" strokeDasharray="3 3" />
        <path d="M0,160 C140,100 270,180 430,110 C480,90 510,50 600,40" stroke="#34D399" strokeWidth="1" />
        <path d="M0,140 C130,80 260,160 410,90 C460,70 500,30 600,20" stroke="#34D399" strokeWidth="0.75" />
      </svg>
