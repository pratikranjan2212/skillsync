...
function formatStipendDisplay(rawStipend) {
  ...
  // If it doesn't contain a number or is explicitly not listed, return "Not Listed"
  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-md hover:shadow-lg transition-all border border-black/5 flex flex-col justify-between gap-5 group">
      ...
      <div className="pt-3 border-t border-neutral-100 flex items-center justify-between gap-3">
        <div>
          {confidence && (
            <span className="inline-flex items-center px-2.5 py-1 text-[11px] font-semibold text-emerald-700 bg-emerald-50/80 rounded-xl border border-emerald-200/80">
              {confidence === "high" ? "High Confidence" : `${confidence.charAt(0).toUpperCase() + confidence.slice(1)} Confidence`}
            </span>
          )}
        </div>
