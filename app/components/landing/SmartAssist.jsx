  ...
  return (
    <section id="fair-match" className="py-20 md:py-28 px-4 sm:px-6 max-w-7xl mx-auto scroll-mt-24">
      <motion.div
        ...
        className="bg-white rounded-4xl p-8 sm:p-12 shadow-[0_30px_90px_-15px_rgba(0,0,0,0.14),0_10px_30px_-10px_rgba(0,0,0,0.06)] border border-black/5 flex flex-col gap-10 transition-shadow duration-500 hover:shadow-[0_40px_100px_-15px_rgba(0,0,0,0.18),0_15px_40px_-10px_rgba(16,185,129,0.1)] scroll-mt-24"
      >
          ...
          {SMART_ASSIST_CARDS.map((card) => {
            ...
            return (
              <FadeInItem key={card.id}>
                <div
                  className={`group bg-white p-6 sm:p-7 rounded-3xl border border-black/10 transition-all duration-300 ease-out hover:-translate-y-2 flex flex-col justify-between gap-4 h-full ${card.cardShadow}`}
                >
                  <div>
                    <div
