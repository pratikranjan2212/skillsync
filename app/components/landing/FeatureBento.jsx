      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 h-full">
          <FadeIn distance={36} delay={0.45} duration={0.9} className="h-full">
            <div className="bg-[#0f241c] rounded-4xl p-6 sm:p-8 text-white flex flex-col justify-between shadow-xl relative overflow-hidden group h-full">
              <div className="relative z-10">
                <span className="inline-flex items-center px-4 py-2 bg-emerald-500/20 text-emerald-300 text-[11px] font-mono uppercase font-bold tracking-wider rounded-full border border-emerald-500/30">
        ...
        <div className="lg:col-span-12">
          <FadeIn distance={40} delay={0.25} duration={0.95}>
            <div className="bg-[#111111] border border-white/10 rounded-[40px] p-8 sm:p-12 text-white shadow-2xl relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8">
