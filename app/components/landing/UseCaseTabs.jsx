      ...
      <FadeIn distance={20} duration={0.5}>
        ...
        >
          <div className="flex justify-center mb-3">
            <span className="px-3.5 sm:px-4 py-1 sm:py-1.5 rounded-full text-xs font-semibold text-neutral-600 bg-white border border-neutral-200/90 shadow-2xs">
              Built for the Ecosystem
            </span>
          </div>

          <FadeIn delay={0.05} distance={18} duration={0.45}>
            <div className="text-center max-w-2xl 2xl:max-w-3xl mx-auto mb-6 sm:mb-8">
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-[#111111] tracking-tight leading-[1.15]">
                How SkillSync Empowers <br className="hidden sm:inline" />
                Every Role
              </h2>
              <p className="text-xs sm:text-sm md:text-base text-neutral-500 font-medium mt-2 sm:mt-3">
          ...
          <FadeIn delay={0.12} distance={20} duration={0.5}>
            <div className="relative w-full rounded-2xl sm:rounded-4xl overflow-hidden bg-neutral-950 min-h-90 sm:min-h-115 md:min-h-130 shadow-lg border border-black/10 flex items-end justify-end px-3 sm:px-5 md:px-6 py-4 sm:py-6 md:py-7">
              ...
              >
                <p className="text-xs sm:text-base md:text-[16px] font-medium text-white/95 leading-relaxed drop-shadow-xs">
                  {activeTab.title}
                </p>

                <div className="flex items-baseline gap-2 sm:gap-3 flex-nowrap">
                  <span className="text-xl sm:text-3xl md:text-4xl font-black text-white tracking-tight whitespace-nowrap drop-shadow-sm">
                    {activeTab.metric}
                  </span>
                  <span className="text-[11px] sm:text-sm md:text-[15px] font-semibold text-white/90 whitespace-nowrap drop-shadow-xs">
            ...
            <div>
              <div className="flex justify-center mt-6 sm:mt-10">
                <Link
                  ...
                  className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-neutral-900 text-white rounded-full font-bold text-xs sm:text-sm hover:bg-neutral-800 transition-all hover:scale-95 active:scale-90 shadow-[0_18px_40px_rgba(0,0,0,0.35)] hover:shadow-[0_12px_28px_rgba(0,0,0,0.25)] group border border-black/10"
                >
                  <RollingText
              ...
              <div className="text-center mt-6 sm:mt-8">
                <p className="text-xs sm:text-sm text-neutral-500 font-medium mb-2">
                  And for every kind of daily rhythm
                </p>
                <div className="flex flex-wrap items-center justify-center gap-x-3 sm:gap-x-6 gap-y-1.5 text-xs sm:text-sm text-neutral-600 font-medium">
