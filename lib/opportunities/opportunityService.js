    ...
    templates: [
      {
        ...
        companies: [
          { name: "Vercel", stipend: "₹60,000 / month", location: "Remote (Worldwide)", workMode: "Remote" },
          { name: "Razorpay", stipend: "₹55,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "Swiggy", stipend: "₹50,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
          { name: "Postman", stipend: "₹65,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "Zerodha", stipend: "₹45,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
        ],
      ...
      },
      {
        ...
        companies: [
          { name: "Linear", stipend: "₹55,000 / month", location: "Remote (Worldwide)", workMode: "Remote" },
          { name: "CRED", stipend: "₹50,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
          { name: "Groww", stipend: "₹45,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
        ],
      ...
      },
      {
        ...
        companies: [
          { name: "Supabase", stipend: "₹70,000 / month", location: "Remote (Worldwide)", workMode: "Remote" },
          { name: "Hasura", stipend: "₹55,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "Zepto", stipend: "₹48,000 / month", location: "Mumbai, MH (On-site)", workMode: "On-site" },
        ],
    ...
    templates: [
      {
        ...
        companies: [
          { name: "Scale AI", stipend: "₹75,000 / month", location: "Remote (Worldwide)", workMode: "Remote" },
          { name: "Sarvam AI", stipend: "₹65,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
          { name: "Microsoft", stipend: "₹70,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "Krutrim AI", stipend: "₹50,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
      ...
      },
      {
        ...
        companies: [
          { name: "Databricks", stipend: "₹68,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "Fractal Analytics", stipend: "₹42,000 / month", location: "Mumbai, MH (On-site)", workMode: "On-site" },
          { name: "Mu Sigma", stipend: "₹40,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
        ],
    ...
    templates: [
      {
        ...
        companies: [
          { name: "HashiCorp", stipend: "₹65,000 / month", location: "Remote (Worldwide)", workMode: "Remote" },
          { name: "Cloudflare", stipend: "₹60,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "InMobi", stipend: "₹48,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
        ],
    ...
    templates: [
      {
        ...
        companies: [
          { name: "PhonePe", stipend: "₹50,000 / month", location: "Bengaluru, KA (Hybrid)", workMode: "Hybrid" },
          { name: "Duolingo", stipend: "₹65,000 / month", location: "Remote (Worldwide)", workMode: "Remote" },
          { name: "Meesho", stipend: "₹45,000 / month", location: "Bengaluru, KA (On-site)", workMode: "On-site" },
        ],
  ...
  for (const cluster of SKILL_CLUSTERS) {
    ...
    for (const template of cluster.templates) {
      for (const comp of template.companies) {
        ...
        // Alternate platform between Indeed and LinkedIn
...
export async function syncOpportunitiesToDb(opportunities = []) {
  ...
  try {
    for (const rawOpp of opportunities) {
      if (!rawOpp) continue;
      const opp = validateAndNormalizeOpportunity(rawOpp);
      if (!opp || !opp.externalId) continue;
