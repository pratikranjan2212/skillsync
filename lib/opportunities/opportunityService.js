    ...
    templates: [
      {
        ...
        complementarySkills: ["React", "Tailwind CSS", "TypeScript", "REST API design", "Next.js"],
      },
      {
        ...
        complementarySkills: ["Figma", "React", "Tailwind CSS", "JavaScript"],
      },
    ],
  },
  {
    ...
    triggers: [
      "node", "node.js", "nodejs", "node js", "express", "fastapi", "django", "spring boot",
    ...
    for (const opp of opportunities) {
      ...
      await prisma.opportunity.upsert({
        ...
        update: {
          ...
          source: opp.source,
          url: opp.linkedinUrl || opp.url || opp.externalUrl,
        },
        create: {
          id: opp.id,
