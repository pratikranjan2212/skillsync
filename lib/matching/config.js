...
export const MATCH_CONFIG = {
  ...
  // Human-Readable Score Bands & Badges (Emerald Green theme for AI Match Score)
  SCORE_BANDS: [
    ...
    { min: 60, max: 74,  label: "Good Match",      color: "emerald", badgeBg: "bg-emerald-50 text-emerald-800 border-emerald-200" },
    { min: 40, max: 59,  label: "Partial Match",   color: "neutral", badgeBg: "bg-neutral-100 text-neutral-700 border-neutral-200" },
    { min: 0,  max: 39,  label: "Weak Match",      color: "neutral", badgeBg: "bg-neutral-100 text-neutral-600 border-neutral-200" },
  ],
