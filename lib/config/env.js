...
export const env = {
  ...
  // Auth providers
  github: {
    clientId: getFirstEnv(["GITHUB_CLIENT_ID", "AUTH_GITHUB_ID"], ""),
    clientSecret: getFirstEnv(["GITHUB_CLIENT_SECRET", "AUTH_GITHUB_SECRET"], ""),
  },
  google: {
    clientId: getFirstEnv(["GOOGLE_CLIENT_ID", "AUTH_GOOGLE_ID"], ""),
    clientSecret: getFirstEnv(["GOOGLE_CLIENT_SECRET", "AUTH_GOOGLE_SECRET"], ""),
  },
  linkedin: {
    clientId: getFirstEnv(["LINKEDIN_CLIENT_ID", "AUTH_LINKEDIN_ID"], ""),
    clientSecret: getFirstEnv(["LINKEDIN_CLIENT_SECRET", "AUTH_LINKEDIN_SECRET"], ""),
  },
  ...
  courseraApiKey: optional("COURSERA_API_KEY") || "kwD4F3akVxOnblOGvEGtflISgvReNXBA5v3Ikvt5b7Dmc5oh",
  ...
  emailAppPassword: optional("EMAIL_APP_PASSWORD"),
};
